...
`cacophony-ik.json` is the complete, unchanged vector selected by
...
The selection was compared structurally against that source. Object key order
and whitespace differ; all field values are unchanged. Its upstream license is
