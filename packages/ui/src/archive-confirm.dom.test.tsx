...
it("lists what archive removes and keeps, and cannot be undone", async () => {
  ...
  render(<ArchiveSessionAction disabled={false} onArchive={onArchive} worktreePath="/Users/dana/src/acme-api/.domovoi/wt-billing-idem" />)
  ...
  expect(kept.textContent).toContain("The session branch, with the files that were never merged")
