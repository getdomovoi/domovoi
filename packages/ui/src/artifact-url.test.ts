...
describe("artifactUrlFor", () => {
  ...
  it("adds an isolated preview bridge channel", () => {
    expect(artifactUrlFor(
      ...
      `http://127.0.0.1:47831/artifacts/preview-1?bridge=preview_channel_123456&parentOrigin=https%3A%2F%2Fapp.domovoi.sh&expires=1800000000&signature=${"c".repeat(43)}`,
    )
  })
})
