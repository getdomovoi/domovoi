...
> The osnova block below is tool guidance only. On conflict, global wins.
...
This repository is indexed by Osnova: a deterministic call graph with exact file:line, no type inference, no LLM. Use its tools before grep and file reads:
