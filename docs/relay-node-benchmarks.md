...
An [earlier run](relay-measurements/node22-linux-x64-initial.json)
...
The [raw samples](relay-measurements/node22-linux-x64.json)
...
[benchmark tool](https://github.com/getdomovoi/domovoi/blob/5211e81826b29601bd61b210693113c9a394ea04/packages/protocol/experimental/relay/node-benchmark.ts) omits
