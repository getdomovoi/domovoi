...
test("validates download inactivity before the installer starts npm", { timeout: testTimeout }, async () => {
  let calls = 0
  await assert.rejects(installer({ version, expectedSha256: "0".repeat(64), inactivityTimeoutMs: 0,
