...
export class RpcWriter {
  ...
  respond(socket: RpcOutboundSocket, payload: unknown): boolean {
    ...
    if (!isObject || !Object.hasOwn(payload, "id") || Object.hasOwn(payload, "method")) {
      const method = isObject && Object.hasOwn(payload, "method") ? String((payload as { method: unknown }).method) : "none"
    ...
    return this.#outbound.send(socket, JSON.stringify(payload))
  }
