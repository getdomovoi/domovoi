...
// since round 14, so they are not controls here; nor is "x.env.example", which
// the union classifier ruled 2026-09-25 reads as secret.
export const cardTextControls = "x.envy.txt, app.envrc.md and src/index.ts"
